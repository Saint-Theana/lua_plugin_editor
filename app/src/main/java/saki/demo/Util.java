...
public class Util
{
    ...
    public static LuaRobot robot;

	public Util()
	{
	}

    public static boolean savetofile(String text, String path)
    {
    ...
    public static boolean createfile(String path, Resources resources)
    {
        try { 
            InputStreamReader inputReader = new InputStreamReader( resources.openRawResource(R.raw.example));
            File file = new File(path);
            file.createNewFile();
